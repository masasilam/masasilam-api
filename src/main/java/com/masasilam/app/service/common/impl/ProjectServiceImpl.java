...
public class ProjectServiceImpl implements ProjectService {
    ...
    private static final String EXPECTED_COMPLETION_DATE = "EXPECTED_COMPLETION_DATE";
    private static final String OVERALL_PROGRESS = "OVERALL_PROGRESS";
    private static final String QUALITY_SCORE = "QUALITY_SCORE";
    ...
    public DatatableResponse<ProjectResponse> getProjects(int page, int limit, String sortField, String sortOrder,
        ...
        allowedSortFields.put("reactionCount", REACTION_COUNT);
    ...
    public DataResponse<String> submitWork(String projectSlug, Integer page, SubmitWorkRequest request) {
        try {
            ...
            ProjectPage projectPage = projectPageMapper.getProjectPageByProjectIdAndPageNumber(project.getId(), page);
            if (projectPage == null) {
                return new DataResponse<>(ERROR,
    ...
    public DataResponse<ProjectStatisticsResponse> getProjectStatistics(String projectSlug) {
        try {
            ...
            stats.setViewCount(project.getViewCount() + 1);
    ...
    private void updateProjectOverallProgress(Long projectId) {
        try {
            ...
            if (project != null && project.getTotalPages() > 0) {
                ...
                int totalPossibleTasks = project.getTotalPages() * 5;

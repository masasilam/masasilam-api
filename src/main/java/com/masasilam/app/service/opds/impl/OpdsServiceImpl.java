...
public class OpdsServiceImpl implements OpdsService {
    ...
    public OpdsFeed getRootCatalog() {
        ...
        entries.add(buildNavEntry("buku-terbaru", "Buku Terbaru",
                "Koleksi buku terbaru yang baru saja ditambahkan",
                apiUrl + "/opds/new", OPDS_ACQUISITION_MIME));
        entries.add(buildNavEntry("semua-genre", "Telusuri per Genre",
                "Jelajahi buku berdasarkan genre dan kategori",
                apiUrl + "/opds/genres", OPDS_CATALOG_MIME));

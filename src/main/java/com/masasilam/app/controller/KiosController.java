...
import com.masasilam.app.service.common.KiosService;
...
public class KiosController {
    ...
    public ResponseEntity<DataResponse<KiosProductResponse>> createProduct(@Valid @RequestPart("data") KiosProductRequest request,
    ...
    @GetMapping("/products")
    public ResponseEntity<DatatableResponse<KiosProductResponse>> getProducts(@RequestParam(defaultValue = "1") int page,
    ...
    public ResponseEntity<DataResponse<KiosProductResponse>> updateProduct(@PathVariable Long id,
    ...
    public ResponseEntity<DataResponse<KiosProductResponse>> updateStock(@PathVariable Long id,
    ...
    public ResponseEntity<DataResponse<List<StockHistoryResponse>>> getStockHistory(@PathVariable Long id,
    ...
    public ResponseEntity<DataResponse<CartResponse>> updateCartItem(@PathVariable Long itemId,
    ...
    @GetMapping("/orders")
    public ResponseEntity<DatatableResponse<KiosOrderResponse>> getOrders(@RequestParam(defaultValue = "1") int page,
                                                                          @RequestParam(defaultValue = "20") int limit,
    ...
    public ResponseEntity<DataResponse<PaymentResponse>> processPayment(@PathVariable String orderNumber,
    ...
    public ResponseEntity<DatatableResponse<KiosOrderResponse>> getAllOrders(@RequestParam(defaultValue = "1") int page,
                                                                             @RequestParam(defaultValue = "20") int limit,
                                                                             @RequestParam(required = false) String status,
                                                                             @RequestParam(required = false) String search) {
    ...
    public ResponseEntity<DataResponse<KiosOrderResponse>> updateOrderStatus(@PathVariable String orderNumber,
    ...
    public ResponseEntity<DataResponse<KiosOrderResponse>> updateShippingInfo(@PathVariable String orderNumber,
    ...
    public ResponseEntity<DataResponse<ProductReviewResponse>> addReview(@PathVariable Long productId,
    ...
    public ResponseEntity<DataResponse<List<ProductReviewResponse>>> getReviews(@PathVariable Long productId,
                                                                                @RequestParam(defaultValue = "1") int page,
                                                                                @RequestParam(defaultValue = "20") int limit) {
    ...
    public ResponseEntity<DataResponse<SalesStatsResponse>> getSalesStats(@RequestParam String period) {

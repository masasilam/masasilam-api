...
import com.masasilam.app.model.entity.ChapterListeningProgress;
...
public interface ChapterProgressMapper {
    ...
    ChapterListeningProgress findListeningProgress(@Param("userId") Long userId, @Param("bookId") Long bookId, @Param("chapterNumber") Integer chapterNumber);

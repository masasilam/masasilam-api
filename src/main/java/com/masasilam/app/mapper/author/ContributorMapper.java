...
public interface ContributorMapper {
    ...
    List<Contributor> findAllWithPagination(@Param("offset") int offset, @Param("limit") int limit, @Param("role") String role, @Param("search") String search);
    ...
    int countBookContributor(@Param("bookId") Long bookId, @Param("contributorId") Long contributorId, @Param("role") String role);

...
import com.masasilam.app.model.dto.response.ProjectActivityResponse;
import com.masasilam.app.model.dto.response.ProjectResponse;
import com.masasilam.app.model.dto.response.UserActivityResponse;
import com.masasilam.app.model.entity.Project;
import com.masasilam.app.model.entity.ProjectActivity;
import com.masasilam.app.model.entity.ProjectQualityAssessment;
...
public interface ProjectMapper {
    List<ProjectResponse> getProjectListWithFilters(@Param("status") String status, @Param("difficulty") String difficulty, @Param("title") String title, @Param("genre") String genre, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);

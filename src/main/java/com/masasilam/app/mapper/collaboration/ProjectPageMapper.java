...
import com.masasilam.app.model.entity.ProjectPage;
...
public interface ProjectPageMapper {
    ...
    void updateTranslationContent(@Param("projectId") Long projectId, @Param("pageNumber") Integer pageNumber, @Param("workContent") String workContent, @Param("userId") Long userId, @Param("notes") String notes);
    void updateEditingContent(@Param("projectId") Long projectId, @Param("pageNumber") Integer pageNumber, @Param("workContent") String workContent, @Param("userId") Long userId, @Param("notes") String notes);
    void updateIllustrationContent(@Param("projectId") Long projectId, @Param("pageNumber") Integer pageNumber, @Param("workContent") String workContent, @Param("userId") Long userId, @Param("notes") String notes);
    void updateProofreadingContent(@Param("projectId") Long projectId, @Param("pageNumber") Integer pageNumber, @Param("workContent") String workContent, @Param("userId") Long userId, @Param("notes") String notes);
    void updateTranscriptionContent(@Param("projectId") Long projectId, @Param("pageNumber") Integer pageNumber, @Param("workContent") String workContent, @Param("userId") Long userId, @Param("notes") String notes);
    void updateReviewContent(@Param("projectId") Long projectId, @Param("pageNumber") Integer pageNumber, @Param("workContent") String workContent, @Param("userId") Long userId, @Param("notes") String notes);

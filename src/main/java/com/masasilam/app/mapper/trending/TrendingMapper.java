...
public interface TrendingMapper {
    ...
    void insertBookTrending(@Param("days") int days, @Param("viewWeight") double viewWeight, @Param("downloadWeight") double downloadWeight,
                            @Param("halfLifeDays") double halfLifeDays, @Param("limit") int limit);
    void insertZineTrending(@Param("days") int days, @Param("viewWeight") double viewWeight, @Param("downloadWeight") double downloadWeight,
                            @Param("halfLifeDays") double halfLifeDays, @Param("limit") int limit);
    void insertFilmTrending(@Param("days") int days, @Param("viewWeight") double viewWeight, @Param("downloadWeight") double downloadWeight,
                            @Param("halfLifeDays") double halfLifeDays, @Param("limit") int limit);
    void insertNewspaperTrending(@Param("days") int days, @Param("viewWeight") double viewWeight, @Param("downloadWeight") double downloadWeight,
                                 @Param("halfLifeDays") double halfLifeDays,@Param("limit") int limit);

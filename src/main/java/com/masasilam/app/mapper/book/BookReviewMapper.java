...
import com.masasilam.app.model.entity.BookReview;
...
public interface BookReviewMapper {
    ...
    List<BookReview> findByBookWithPagination(@Param("bookId") Long bookId, @Param("offset") int offset, @Param("limit") int limit, @Param("sortBy") String sortBy);

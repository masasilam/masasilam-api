package com.masasilam.app.mapper.blog;

import com.masasilam.app.model.dto.response.*;
import com.masasilam.app.model.entity.BlogComment;
import com.masasilam.app.model.entity.BlogPost;
...
public interface BlogPostMapper {
    ...
    List<BlogPostResponse> getBlogPostsWithFilters(@Param("status") String status, @Param("category") String category, @Param("tag") String tag, @Param("search") String search, @Param("authorId") Long authorId, @Param("adminMode") boolean adminMode, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);
    List<BlogPostResponse> getTrendingBlogPosts(@Param("days") int days, @Param("offset") int offset, @Param("limit") int limit);
    List<BlogPostResponse> getBlogPostsByCategory(@Param("categorySlug") String categorySlug, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);
    List<BlogPostResponse> getBlogPostsByTag(@Param("tagSlug") String tagSlug, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);
    List<BlogPostResponse> getBlogPostsByAuthor(@Param("authorId") Long authorId, @Param("status") String status, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);
    List<BlogPostResponse> searchBlogPosts(@Param("query") String query, @Param("category") String category, @Param("tag") String tag, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);
    List<BlogPostResponse> getRelatedBlogPosts(@Param("blogPostId") Long blogPostId, @Param("limit") int limit);
    BlogPostDetailResponse getBlogPostByIdForAdmin(@Param("id") Long id);
    ...
    List<BlogCommentResponse> getBlogPostComments(@Param("blogPostId") Long blogPostId, @Param("offset") int offset, @Param("limit") int limit, @Param("sortColumn") String sortColumn, @Param("sortType") String sortType);
    ...
    List<MonthlyStatsResponse> getMonthlyStatsByUser(@Param("userId") Long userId, @Param("months") int months);
}
...
public interface NewspaperMapper {
    ...
    List<NewspaperSourceResponse> getAllSources(@Param("offset") int offset, @Param("limit") int limit, @Param("search") String search);
    int countAllSources(@Param("search") String search);
    NewspaperStatsResponse getOverallStats();
    List<NewspaperArticleResponse> getArticlesByCategory(@Param("categorySlug") String categorySlug, @Param("offset") int offset, @Param("limit") int limit, @Param("sortBy") String sortBy, @Param("sortOrder") String sortOrder, @Param("criteria") NewspaperSearchCriteria criteria);
    ...
    List<NewspaperArticleResponse> getArticlesOnThisDay(@Param("month") int month, @Param("day") int day, @Param("offset") int offset, @Param("limit") int limit);
    int countArticlesOnThisDay(@Param("month") int month, @Param("day") int day);
    NewspaperAnalyticsResponse getAnalyticsOverview(@Param("dateFrom") LocalDate dateFrom, @Param("dateTo") LocalDate dateTo);
    List<NewspaperArticleResponse> getTrendingArticles(@Param("days") int days, @Param("limit") int limit);
    List<NewspaperArticleResponse> getRelatedArticles(@Param("articleId") Long articleId, @Param("category") String category, @Param("limit") int limit);
    List<NewspaperArticleResponse> getSameDateArticles(@Param("articleId") Long articleId, @Param("date") LocalDate date, @Param("limit") int limit);
    boolean isArticleSavedByUser(@Param("articleId") Long articleId, @Param("userId") Long userId);
    boolean hasUserReviewedArticle(@Param("userId") Long userId, @Param("articleId") Long articleId);
    boolean hasViewByHash(@Param("viewerHash") String viewerHash, @Param("actionType") String actionType);

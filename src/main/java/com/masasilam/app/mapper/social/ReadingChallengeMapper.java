...
public interface ReadingChallengeMapper {
    ...
    ReadingChallengeResponse getChallengeDetail(@Param("challengeId") Long challengeId, @Param("currentUserId") Long currentUserId);
    List<ReadingChallengeResponse> findActiveChallenges(@Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    List<ReadingChallengeResponse> findUserChallenges(@Param("userId") Long userId, @Param("status") String status, @Param("offset") int offset, @Param("limit") int limit);
    ...
    boolean progressItemExists(@Param("participantId") Long participantId, @Param("entityType") String entityType, @Param("entityId") Long entityId);
    List<ChallengeProgressItemResponse> findProgressByParticipant(Long participantId);
    List<ChallengeLeaderboardResponse.LeaderboardEntryResponse> getLeaderboard(@Param("challengeId") Long challengeId, @Param("offset") int offset, @Param("limit") int limit);

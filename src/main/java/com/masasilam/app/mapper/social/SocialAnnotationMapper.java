...
public interface SocialAnnotationMapper {
    ...
    List<SocialAnnotationResponse> findPublicAnnotations(@Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    List<SocialAnnotationResponse> findFollowingAnnotations(@Param("userId") Long userId, @Param("offset") int offset, @Param("limit") int limit);
    List<SocialAnnotationResponse> findByUser(@Param("profileUserId") Long profileUserId, @Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    List<SocialAnnotationResponse> findByEntity(@Param("entityType") String entityType, @Param("entityId") Long entityId, @Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    ...
    List<AnnotationCommentResponse> findCommentsByAnnotation(@Param("annotationId") Long annotationId, @Param("currentUserId") Long currentUserId);

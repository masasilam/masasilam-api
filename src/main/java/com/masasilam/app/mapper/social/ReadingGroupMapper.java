...
public interface ReadingGroupMapper {
    ...
    List<ReadingGroupResponse> findPublicGroups(@Param("search") String search, @Param("focusType") String focusType, @Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    List<ReadingGroupResponse> findUserGroups(@Param("userId") Long userId, @Param("offset") int offset, @Param("limit") int limit);
    ...
    List<GroupMemberResponse> findMembers(@Param("groupId") Long groupId, @Param("offset") int offset, @Param("limit") int limit);
    ...
    List<GroupDiscussionResponse> findDiscussionsByGroup(@Param("groupId") Long groupId, @Param("scheduleId") Long scheduleId, @Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    List<GroupDiscussionResponse> findRepliesByParent(@Param("parentId") Long parentId, @Param("currentUserId") Long currentUserId);
    ...
    List<GroupMemberResponse> getMemberProgressLeaderboard(@Param("groupId") Long groupId, @Param("entityType") String entityType, @Param("entityId") Long entityId);
}
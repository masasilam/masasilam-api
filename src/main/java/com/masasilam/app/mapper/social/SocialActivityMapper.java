...
public interface SocialActivityMapper {
    ...
    List<ActivityFeedItemResponse> getFollowingFeed(@Param("userId") Long userId, @Param("offset") int offset, @Param("limit") int limit);
    List<ActivityFeedItemResponse> getPublicFeed(@Param("offset") int offset, @Param("limit") int limit);
    List<ActivityFeedItemResponse> getUserActivities(@Param("profileUserId") Long profileUserId, @Param("currentUserId") Long currentUserId, @Param("offset") int offset, @Param("limit") int limit);
    ...
    List<ActivityCommentResponse> findCommentsByActivity(@Param("activityId") Long activityId, @Param("currentUserId") Long currentUserId);

...
public interface FilmMapper {
    ...
    void insertFilmPerson(@Param("filmId") Long filmId, @Param("personId") Long personId, @Param("role") String role);
    List<Person> findPersonsByFilmIdAndRole(@Param("filmId") Long filmId, @Param("role") String role);
    void deletePersonsByFilmIdAndRole(@Param("filmId") Long filmId, @Param("role") String role);
    void deletePersonsByFilmId(Long filmId);
    void insertCompany(Company company);
    void updateCompany(Company company);
    Company findCompanyBySlug(String slug);
    void insertFilmProductionCompany(@Param("filmId") Long filmId, @Param("companyId") Long companyId);
    void insertFilmDistributor(@Param("filmId") Long filmId, @Param("companyId") Long companyId);
    ...
    void insertLocation(@Param("filmId") Long filmId, @Param("type") String type, @Param("name") String name);
    List<String> findLocationsByFilmIdAndType(@Param("filmId") Long filmId, @Param("type") String type);
    void deleteLocationsByFilmId(Long filmId);
    void insertAlias(@Param("filmId") Long filmId, @Param("alias") String alias, @Param("language") String language);
    List<String> findAliasesByFilmIdAndLanguage(@Param("filmId") Long filmId, @Param("language") String language);

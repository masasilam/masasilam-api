package com.naskah.app.controller.book;
...
import com.naskah.app.service.CorrectionService;
import com.naskah.app.service.book.BookChapterService;
...
public class BookChapterController {
    ...
    public ResponseEntity<DataResponse<ChapterProgressResponse>> saveChapterProgress(@PathVariable String slug, @PathVariable Integer chapterNumber, @Valid @RequestBody ChapterProgressRequest request) {
    ...
    public ResponseEntity<DataResponse<BookmarkResponse>> addChapterBookmark(@PathVariable String slug, @PathVariable Integer chapterNumber, @Valid @RequestBody ChapterBookmarkRequest request) {
    ...
    public ResponseEntity<DataResponse<HighlightResponse>> addChapterHighlight(@PathVariable String slug, @PathVariable Integer chapterNumber, @Valid @RequestBody ChapterHighlightRequest request) {
    ...
    public ResponseEntity<DataResponse<Void>> deleteChapterBookmark(@PathVariable String slug, @PathVariable Integer chapterNumber, @PathVariable Long bookmarkId) {
    ...
    public ResponseEntity<DataResponse<Void>> deleteChapterHighlight(@PathVariable String slug, @PathVariable Integer chapterNumber, @PathVariable Long highlightId) {
    ...
    public ResponseEntity<DataResponse<Void>> deleteChapterNote(@PathVariable String slug, @PathVariable Integer chapterNumber, @PathVariable Long noteId) {
        DataResponse<Void> response = chapterService.deleteChapterNote(slug, chapterNumber, noteId);
        return ResponseEntity.ok(response);
    }

    @GetMapping("/{chapterNumber}/reviews")
    public ResponseEntity<DataResponse<List<ChapterReviewResponse>>> getChapterReviews(@PathVariable String slug, @PathVariable Integer chapterNumber, @RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int limit) {
    ...
    public ResponseEntity<DataResponse<ChapterReviewResponse>> addChapterReview(@PathVariable String slug, @PathVariable Integer chapterNumber, @Valid @RequestBody ChapterReviewRequest request) {
    ...
    public ResponseEntity<DataResponse<ChapterReviewResponse>> replyToChapterReview(@PathVariable String slug, @PathVariable Integer chapterNumber, @PathVariable Long reviewId, @Valid @RequestBody ChapterReplyRequest request) {
    ...
    public ResponseEntity<DataResponse<Void>> likeChapterReview(@PathVariable String slug, @PathVariable Integer chapterNumber, @PathVariable Long reviewId) {
    ...
    public ResponseEntity<DataResponse<Void>> unlikeChapterReview(@PathVariable String slug, @PathVariable Integer chapterNumber, @PathVariable Long reviewId) {
        DataResponse<Void> response = chapterService.unlikeChapterReview(slug, chapterNumber, reviewId);
        return ResponseEntity.ok(response);
    }

    @GetMapping("/{chapterNumber}/text")
    public ResponseEntity<DataResponse<ChapterTextResponse>> getChapterText(@PathVariable String slug, @PathVariable Integer chapterNumber) {
    ...
    public ResponseEntity<DataResponse<ChapterParagraphsResponse>> getChapterParagraphs(@PathVariable String slug, @PathVariable Integer chapterNumber) {
    ...
    public ResponseEntity<DataResponse<ChapterRatingResponse>> rateChapter(@PathVariable String slug, @PathVariable Integer chapterNumber, @Valid @RequestBody ChapterRatingRequest request) {
        DataResponse<ChapterRatingResponse> response = chapterService.rateChapter(slug, chapterNumber, request);
        return ResponseEntity.ok(response);
    }

    @GetMapping("/{chapterNumber}/rating")
    public ResponseEntity<DataResponse<ChapterRatingSummaryResponse>> getChapterRating(@PathVariable String slug, @PathVariable Integer chapterNumber) {
        DataResponse<ChapterRatingSummaryResponse> response = chapterService.getChapterRatingSummary(slug, chapterNumber);
        return ResponseEntity.ok(response);
    }

    @DeleteMapping("/{chapterNumber}/rating")
    public ResponseEntity<DataResponse<Void>> deleteChapterRating(@PathVariable String slug, @PathVariable Integer chapterNumber) {
        DataResponse<Void> response = chapterService.deleteChapterRating(slug, chapterNumber);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<DataResponse<ExportHistoryResponse>> getExportHistory(@PathVariable String slug, @RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int limit) {
    ...
    public ResponseEntity<DataResponse<BookAnalyticsResponse>> getBookAnalytics(@PathVariable String slug, @RequestParam(required = false) String dateFrom, @RequestParam(required = false) String dateTo) {
    ...
    public ResponseEntity<DataResponse<CorrectionResponse>> submitCorrection(@PathVariable String slug, @PathVariable Integer chapterNumber, @Valid @RequestBody SubmitCorrectionRequest request) {
    ...
    public ResponseEntity<DataResponse<List<Integer>>> getPendingCorrectionPositions(@PathVariable String slug, @PathVariable Integer chapterNumber) {
        DataResponse<List<Integer>> response = correctionService.getPendingPositions(slug, chapterNumber);
        return ResponseEntity.ok(response);
    }
}
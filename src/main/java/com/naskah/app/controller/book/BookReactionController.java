...
import com.naskah.app.service.book.BookReactionService;
...
public class BookReactionController {
    ...
    @PostMapping("/rating")
    public ResponseEntity<DataResponse<BookRatingResponse>> addOrUpdateBookRating(@PathVariable String slug, @Valid @RequestBody RatingRequest request) {
    ...
    @GetMapping("/reviews")
    public ResponseEntity<DatatableResponse<BookReviewResponse>> getBookReviews(@PathVariable String slug,
    ...
    @PostMapping("/reviews")
    public ResponseEntity<DataResponse<BookReviewResponse>> createBookReview(@PathVariable String slug, @Valid @RequestBody BookReviewRequest request) {
        DataResponse<BookReviewResponse> response = reactionService.createBookReview(slug, request);
        return ResponseEntity.status(HttpStatus.CREATED).body(response);
    }

    @PutMapping("/reviews")
    public ResponseEntity<DataResponse<BookReviewResponse>> updateBookReview(@PathVariable String slug, @Valid @RequestBody BookReviewRequest request) {
    ...
    public ResponseEntity<DataResponse<BookReviewReplyResponse>> addReplyToBookReview(@PathVariable String slug, @PathVariable Long reviewId,
    ...
    public ResponseEntity<DataResponse<BookReviewReplyResponse>> updateBookReviewReply(@PathVariable String slug, @PathVariable Long replyId,
                                                                                       @Valid @RequestBody ReplyRequest request) {
    ...
    public ResponseEntity<DataResponse<Void>> deleteBookReviewReply(@PathVariable String slug, @PathVariable Long replyId) {
        DataResponse<Void> response = reactionService.deleteBookReviewReply(slug, replyId);
        return ResponseEntity.ok(response);
    }

    @PostMapping("/reviews/{reviewId}/feedback")
    public ResponseEntity<DataResponse<Void>> addOrUpdateBookReviewFeedback(@PathVariable String slug, @PathVariable Long reviewId,
    ...
    public ResponseEntity<DataResponse<Void>> deleteBookReviewFeedback(@PathVariable String slug, @PathVariable Long reviewId) {

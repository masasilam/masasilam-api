...
import com.naskah.app.mapper.BlogPostMapper;
...
import com.naskah.app.model.enums.*;
...
public class BlogPostServiceImpl implements BlogPostService {
    ...
    public DataResponse<BlogPostResponse> createBlogPost(CreateBlogPostRequest request,
        ...
        post.setSource(request.getSource());
    ...
    public DataResponse<BlogPostResponse> updateBlogPost(Long id, UpdateBlogPostRequest request,
        ...
        update.setSource(request.getSource() != null ? request.getSource() : existing.getSource());

...
import com.naskah.app.mapper.ZineReadingProgressMapper;
import com.naskah.app.mapper.ZineReadingSessionMapper;
...
import com.naskah.app.model.entity.ZineReadingProgress;
import com.naskah.app.model.entity.ZineReadingSession;
import com.naskah.app.service.zine.ZineReadingService;
...
public class ZineReadingServiceImpl implements ZineReadingService {
    ...
    @Override
    @Transactional
    public DataResponse<ZineReadingSessionResponse> saveReadingSession(String slug,
                                                                       ZineReadingSessionRequest request) {
        ...
        session.setTotalDurationSeconds(request.getTotalDurationSeconds() != null
    ...
    @Override
    @Transactional
    public DataResponse<ZineReadingProgressResponse> saveOrUpdateProgress(String slug,
                                                                          ZineReadingProgressRequest request) {
        User user = requireUser();
        Zine zine = requireZine(slug);

...
import com.naskah.app.model.entity.Note;
import com.naskah.app.model.entity.NoteComment;
...
public interface NoteMapper {
    ...
    @Insert("INSERT INTO notes (user_id, book_id, chapter_number, chapter_title, chapter_slug, start_position, end_position, content, selected_text, created_at, updated_at) " +
            "VALUES (#{userId}, #{bookId}, #{chapterNumber}, #{chapterTitle}, #{chapterSlug}, #{startPosition}, #{endPosition}, #{content}, #{selectedText}, #{createdAt}, #{updatedAt})")

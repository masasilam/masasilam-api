...
import com.naskah.demo.model.dto.request.EpubSessionRequest;
import com.naskah.demo.model.dto.request.EpubStartReadingRequest;
...
public class ZineEpubAnnotationController {
    ...
    public ResponseEntity<DataResponse<EpubAnnotationResponse>> addAnnotation(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(epubAnnotationService.addAnnotation(slug, request));
    }
    ...
    public ResponseEntity<DataResponse<EpubBookmarkResponse>> addBookmark(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(epubAnnotationService.addBookmark(slug, request));
    }

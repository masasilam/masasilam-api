package com.naskah.demo.controller.opds;

import com.naskah.demo.model.dto.opds.OpdsFeed;
import com.naskah.demo.service.opds.OpdsService;
import com.naskah.demo.util.opds.OpdsXmlBuilder;
...
public class OpdsController {
    ...
    public ResponseEntity<String> rootCatalog() {
        ...
        return ResponseEntity.ok()
                .contentType(MediaType.parseMediaType(OPDS_CONTENT_TYPE))
                .body(xmlBuilder.buildFeed(feed));
    }

...
public class BlogPostController {
    ...
    /**
     * ✅ Upload gambar inline konten artikel ke Cloudinary.
     * postId opsional — kirim jika artikel sudah tersimpan (edit mode),
     * boleh null jika artikel baru belum punya ID.
     * Return: { "data": { "url": "https://res.cloudinary.com/..." } }
     */
    @PostMapping(value = "/upload-image", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<DataResponse<Map<String, String>>> uploadInlineImage(

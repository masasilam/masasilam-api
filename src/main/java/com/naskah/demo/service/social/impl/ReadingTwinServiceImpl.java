...
import com.naskah.demo.mapper.social.ReadingTwinMapper;
import com.naskah.demo.model.dto.response.*;
import com.naskah.demo.model.dto.response.social.*;
import com.naskah.demo.model.entity.User;
import com.naskah.demo.model.entity.social.ReadingTwin;
...
public class ReadingTwinServiceImpl implements ReadingTwinService {
    ...
    public DataResponse<List<ReadingTwinResponse>> getMyTwins(int page, int limit) {
        ...
        List<ReadingTwinResponse> twins =
                twinMapper.findTwinsForUser(me.getId(), me.getId(), offset, limit);
    ...
    public void calculateTwinsForUser(Long userId) {
        try {
            ...
            for (Long otherId : compareIds) {
                ...
                try {
                    // Simplified similarity: based on common reads count
                    // In production, use Jaccard similarity or cosine similarity
